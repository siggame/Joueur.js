...
class uJob extends GameObject {
   ...
   */
  get damageVsTowers() {
    return client.gameManager.getMemberValue(this, 'damageVsTowers');
  }

  set damageVsTowers(value) {
    client.gameManager.setMemberValue(this, 'damageVsTowers', value);
  }
