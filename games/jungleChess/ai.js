// This is where you build your AI for the JungleChess game.
...
/**
 * This is the class to play the JungleChess game. This is where you should build your AI.
...
class AI extends BaseAI {
  ...
  getName() {
    ...
    return 'JungleChess JavaScript Player';
    // <<-- /Creer-Merge: getName -->>
  }
   ...
   *
   * @returns {string} - A string formatting for the move you want to make. If the move is invalid or not properly formatted you will lose the game.
   */
  makeMove() {
